...
const summary: Record<string, { es: string; en: string; pt: string }> = {
  ...
  'summary.joinLine': { es: 'Unión de puntos', en: 'Point connection', pt: 'União de pontos' },
  'summary.joinNone': { es: 'Sin unión', en: 'No line', pt: 'Sem união' },
  'summary.joinLinear': { es: 'Unión lineal', en: 'Straight lines', pt: 'União linear' },
  'summary.joinSmooth': { es: 'Unión suavizada', en: 'Smoothed lines', pt: 'União suavizada' },
