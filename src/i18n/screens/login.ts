...
const login: Record<string, { es: string; en: string; pt: string }> = {
  ...
  'login.signupNameLabel': { es: 'Nombre completo', en: 'Full name', pt: 'Nome completo' },
  'login.signupEmailLabel': { es: 'Correo electrónico', en: 'Email', pt: 'E-mail' },
  'login.signupPasswordLabel': { es: 'Contraseña', en: 'Password', pt: 'Senha' },
  'login.signupConfirmLabel': { es: 'Confirmar contraseña', en: 'Confirm password', pt: 'Confirmar senha' },
  'login.signupConfirmPlaceholder': { es: 'Repite la contraseña', en: 'Repeat the password', pt: 'Repita a senha' },
  'login.signupMismatch': { es: 'Las contraseñas no coinciden.', en: 'Passwords do not match.', pt: 'As senhas não coincidem.' },
