...
const fileUpload: Record<string, { es: string; en: string; pt: string }> = {
  ...
  'fileUpload.stamp.commentDesc': { es: 'Aparece junto al nombre del proyecto: "Nombre del proyecto - Comentario".', en: 'Shown next to the project name: "Project name - Comment".', pt: 'Aparece ao lado do nome do projeto: "Nome do projeto - Comentário".' },
  'fileUpload.stamp.commentPlaceholder': { es: 'Ej: Fase 2', en: 'E.g.: Phase 2', pt: 'Ex.: Fase 2' },
  'fileUpload.stamp.gpsLabel': { es: 'Datos GPS', en: 'GPS data', pt: 'Dados GPS' },
  'fileUpload.stamp.gpsDesc': { es: 'Plotea las coordenadas GPS dentro del estampado de cada foto.', en: 'Stamps the GPS coordinates inside each photo.', pt: 'Carimba as coordenadas GPS dentro de cada foto.' },
  'fileUpload.stamp.sizeLabel': { es: 'Tamaño del estampado', en: 'Stamp size', pt: 'Tamanho do carimbo' },
  'fileUpload.stamp.sizeDesc': { es: 'Tamaño de la letra y el logo en la foto.', en: 'Text and logo size on the photo.', pt: 'Tamanho do texto e do logotipo na foto.' },
  'fileUpload.stamp.size_normal': { es: 'Normal', en: 'Normal', pt: 'Normal' },
  'fileUpload.stamp.size_compact': { es: 'Compacta', en: 'Compact', pt: 'Compacta' },
  'fileUpload.stamp.size_very_compact': { es: 'Muy compacta', en: 'Very compact', pt: 'Muito compacta' },
