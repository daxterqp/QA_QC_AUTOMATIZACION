/**
 * sampleCode (v43) — Código correlativo de MUESTRAS físicas. Espejo de
 * `src/utils/sampleCode.ts` (móvil). Puro, sin dependencias.
 *
 * Sintaxis: `M-{sample_identifier}-{ddmmyy}-{seq:4}`  (seq global por proyecto).
 * Ej.: proyecto "123", 17/06/2026, muestra #1 → `M-123-170626-0001`.
 */
