 ...
 *  progresiva (geometría pura, estable). */
 ...
 * manual / recálculo: mantiene progresiva y subtramo CONSISTENTES con el sector
 * asignado. Devuelve null si el tramo no existe o no tiene progresivas.
 */
