...
export const STRINGS_WEB_DASH: Record<string, { es: string; en: string; pt: string }> = {
  ...
  // ── Dashboard: gráficos v100l (espejo del móvil) ──
  'webDash.trendNone': { es: 'Ninguna', en: 'None', pt: 'Nenhuma' },
  'webDash.trendKindLinear': { es: 'lineal', en: 'linear', pt: 'linear' },
  'webDash.trendKindQuad': { es: 'cuadrática', en: 'quadratic', pt: 'quadrática' },
  'webDash.trendKindCubic': { es: 'cúbica', en: 'cubic', pt: 'cúbica' },
  'webDash.trendLegend': { es: 'Tendencia {kind}', en: '{kind} trend', pt: 'Tendência {kind}' },
  'webDash.joinLine': { es: 'Unión de puntos', en: 'Point connection', pt: 'União de pontos' },
  'webDash.joinNone': { es: 'Sin unión', en: 'No line', pt: 'Sem união' },
  'webDash.joinLinear': { es: 'Unión lineal', en: 'Straight lines', pt: 'União linear' },
  'webDash.joinSmooth': { es: 'Unión suavizada', en: 'Smoothed lines', pt: 'União suavizada' },
  'webDash.chartAxesTitle': { es: 'Ejes del gráfico', en: 'Chart axes', pt: 'Eixos do gráfico' },
  'webDash.shareChart': { es: 'Compartir gráfico', en: 'Share chart', pt: 'Compartilhar gráfico' },
  'webDash.axisYRange': { es: 'Eje Y — rango (vacío = automático)', en: 'Y axis — range (empty = auto)', pt: 'Eixo Y — intervalo (vazio = automático)' },
  'webDash.axisXRange': { es: 'Eje X — rango (vacío = automático)', en: 'X axis — range (empty = auto)', pt: 'Eixo X — intervalo (vazio = automático)' },
  'webDash.axisXDates': { es: 'Eje X — rango de fechas (vacío = automático)', en: 'X axis — date range (empty = auto)', pt: 'Eixo X — intervalo de datas (vazio = automático)' },
  'webDash.gridSpacing': { es: 'Separación de divisiones (vacío = automática)', en: 'Grid spacing (empty = auto)', pt: 'Separação das divisões (vazio = automática)' },
  'webDash.gridH': { es: 'Horizontales (Y)', en: 'Horizontal (Y)', pt: 'Horizontais (Y)' },
  'webDash.gridV': { es: 'Verticales (X)', en: 'Vertical (X)', pt: 'Verticais (X)' },
  'webDash.gridVDays': { es: 'Verticales (días)', en: 'Vertical (days)', pt: 'Verticais (dias)' },
  'webDash.limitLines': { es: 'Líneas de límite (horizontales punteadas)', en: 'Limit lines (dashed horizontal)', pt: 'Linhas de limite (horizontais tracejadas)' },
  'webDash.limitMin': { es: 'Límite mín.', en: 'Min limit', pt: 'Limite mín.' },
  'webDash.limitMax': { es: 'Límite máx.', en: 'Max limit', pt: 'Limite máx.' },
  'webDash.limMinShort': { es: 'mín', en: 'min', pt: 'mín' },
  'webDash.limMaxShort': { es: 'máx', en: 'max', pt: 'máx' },
  'webDash.showLegend': { es: 'Mostrar leyenda de líneas', en: 'Show line legend', pt: 'Mostrar legenda de linhas' },
  'webDash.showVGrid': { es: 'Cuadrícula vertical', en: 'Vertical grid', pt: 'Grade vertical' },
  'webDash.showEq': { es: 'Mostrar ecuación de ajuste y R²', en: 'Show fit equation and R²', pt: 'Mostrar equação de ajuste e R²' },
  'webDash.showStats': { es: 'Mostrar cálculos (media, σ, n)', en: 'Show stats (mean, σ, n)', pt: 'Mostrar cálculos (média, σ, n)' },
  'webDash.xDatesVertical': { es: 'Fechas del eje X en vertical', en: 'Vertical X-axis dates', pt: 'Datas do eixo X na vertical' },
  'webDash.xLabelsVertical': { es: 'Etiquetas del eje X en vertical', en: 'Vertical X-axis labels', pt: 'Rótulos do eixo X na vertical' },
  'webDash.daysNote': { es: '(t: días desde el 1.er ensayo)', en: '(t: days since 1st test)', pt: '(t: dias desde o 1.º ensaio)' },
  'webDash.min': { es: 'Mínimo', en: 'Minimum', pt: 'Mínimo' },
  'webDash.max': { es: 'Máximo', en: 'Maximum', pt: 'Máximo' },
  'webDash.none': { es: 'ninguno', en: 'none', pt: 'nenhum' },
